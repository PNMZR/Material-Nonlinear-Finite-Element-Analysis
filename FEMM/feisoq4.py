...
def feisoq4(rvalue, svalue):
    """
    Purpose:
        Compute isoparametric four-node quadrilateral shape functions and their
        derivatves at the selected (integration) point in terms of the natural
        coordinate.

    Synopsis: shapeq4, dhdrq4, dhdsq4 = feisoq4(rvalue, svalue)
    ...
    # ---------------
    shapeq4 = np.zeros(4)
    shapeq4[0] = 0.25*(1-rvalue)*(1-svalue);
